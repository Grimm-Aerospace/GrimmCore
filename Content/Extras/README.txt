...
BDBKerbalismScienceUpdate - adds (some) missing Kerbalism science definitions for BDB. Work in progress. Currently Keyhole and some other early satellites are supported (Nimbus, OGO, OAO, OFO, GATV, etc).
